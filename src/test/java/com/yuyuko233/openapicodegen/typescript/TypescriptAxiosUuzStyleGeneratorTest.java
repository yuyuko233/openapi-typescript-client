 ...
 * 1) Set a break point in TypescriptAxiosUuzStyleGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class TypescriptAxiosUuzStyleGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("typescript-axios-uuz-style") // use this codegen library
              ...
              .setOutputDir("out/typescript-axios-uuz-style"); // output directory
